...
function getCurrentShape(aShapes) {
  const children = paintObjectList.children;
  for (let i = 0; i < children.length; i++) {
    const child = children[i];
    if (child.classList.contains("selected")) {
...
export function addShape(aText) {
...
export function removeShape(aShapes) {
  const name = getCurrentShape();
  const children = paintObjectList.children;
  for (let i = 0; i < children.length; i++) {
    const child = children[i];
...
export function moveShapeDown(aShapes) {
  const name = getCurrentShape();
  const children = paintObjectList.children;
  for (let i = 0; i < children.length; i++) {
    const child = children[i];
...
export function moveShapeUp(aShapes) {
  const name = getCurrentShape();
  const children = paintObjectList.children;
  for (let i = 0; i < children.length; i++) {
    const child = children[i];
...
export function create(aClickFunction) {
...
export function init(aReadyCallback) {
  imgSheet = new Image();
